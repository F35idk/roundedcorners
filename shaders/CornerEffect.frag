...
void main ()
{
    ...
    window_coords = vec2(window_coords.x-left_hor_offset+0, window_coords.y-top_vert_offset+0);
    window_dimensions = vec2(width-total_hor_offset+0, height-total_vert_offset+0);
