...
void main ()
{
    ...
    window_coords = vec2(window_coords.x-left_hor_offset, window_coords.y-top_vert_offset);
    window_dimensions = vec2(width-total_hor_offset, height-total_vert_offset);
